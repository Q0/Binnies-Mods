...
public class WindowIsolator extends WindowMachine {
   ...
   public void initialiseClient() {
      ...
      x = x + 20;
      new ControlIconDisplay(this, (float)x, (float)(y + 3 + 1), GUIIcon.ArrowRight.getIcon());
      x = x + 18;
      (new ControlSlot(this, (float)x, (float)(y + 3))).assign(5);
      (new ControlSlot(this, (float)x, (float)(y + 36 + 3))).assign(0);
      ...
      x = x + 142;
      (new ControlSlot(this, (float)x, (float)(y + 3))).assign(6);
      (new ControlSlot(this, (float)x, (float)(y + 3 + 36))).assign(1);
      new ControlIconDisplay(this, (float)(x + 1), (float)(y + 3 + 19), GUIIcon.ArrowUp.getIcon());
      x = x + 20;
      new ControlIconDisplay(this, (float)x, (float)(y + 3 + 1), GUIIcon.ArrowRight.getIcon());
      x = x + 18;
