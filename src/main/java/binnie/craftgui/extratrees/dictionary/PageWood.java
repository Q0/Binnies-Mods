...
public class PageWood extends PageAbstract {
    ...
    public void onValueChanged(ItemStack species) {
        ...
        new ControlText(this, new IArea(0.0F, 0.0F, this.size().x(), 24.0F), ((DatabaseTab) this.getValue()).toString(), TextJustification.MiddleCenter);
