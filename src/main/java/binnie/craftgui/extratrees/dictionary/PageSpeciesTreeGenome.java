...
public class PageSpeciesTreeGenome extends PageSpecies {
    ...
    public void onValueChanged(final IAlleleSpecies species) {
        ...
        y += th;
        final IIcon leaf = ForestryAPI.textureManager.getIcon(treeSpecies.getLeafIconIndex(tree, false));
        IIcon fruit = null;
        ...
        if (leaf != null) {
            ...
            new ControlBlockIconDisplay(contents, w2, y, leaf).setColour(treeSpecies.getLeafColour(tree));
