...
public class GuiCraftGUI extends GuiContainer {
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float par3) {
        ...
        GL11.glDisable(2929);
        this.zLevel = 10.0f;
        GuiCraftGUI.itemRender.zLevel = this.zLevel;
        this.window.render();
    ...
    public void renderTooltip(final IPoint mousePosition, final MinecraftTooltip tooltip) {
        ...
        this.zLevel = 300.0f;
        GuiCraftGUI.itemRender.zLevel = 300.0f;
        ...
        for (int k3 = 0; k3 < strings.size(); ++k3) {
            ...
            if (s2.contains("~~~")) {
                ...
                try {
                    ...
                    GL11.glPushMatrix();
                    GL11.glTranslatef((float) i1, j1 - 1.5f, 0.0f);
        ...
        this.zLevel = 0.0f;
        GuiCraftGUI.itemRender.zLevel = 0.0f;
        GL11.glEnable(2896);
        GL11.glEnable(2929);
    ...
    protected void mouseMovedOrUp(final int x, final int y, final int button) {
        ...
        if (button == -1) {
            final float dx = Mouse.getEventDX() * this.width / this.mc.displayWidth;
            final float dy = -(Mouse.getEventDY() * this.height / this.mc.displayHeight);
        } else {
    ...
    public void renderIcon(final IPoint pos, final IIcon icon, final ResourceLocation map) {
        ...
        GuiCraftGUI.itemRender.zLevel = this.zLevel;
        GuiCraftGUI.itemRender.renderIcon((int) pos.x(), (int) pos.y(), icon, 16, 16);
        GL11.glEnable(32826);
        GL11.glPopMatrix();
    }
    ...
    public void limitArea(final IArea area) {
        ...
        final float scaleX = this.width / this.mc.displayWidth;
        final float scaleY = this.height / this.mc.displayHeight;
        x += 0.0f;
        y += 0.0f;
        w += 0.0f;
        h += 0.0f;
    ...
    public void drawRect(float p_73734_0_, float p_73734_1_, float p_73734_2_, float p_73734_3_, final int p_73734_4_) {
        ...
        tessellator.startDrawingQuads();
        tessellator.addVertex((double) p_73734_0_, (double) p_73734_3_, 0.0);
        tessellator.addVertex((double) p_73734_2_, (double) p_73734_3_, 0.0);
        tessellator.addVertex((double) p_73734_2_, (double) p_73734_1_, 0.0);
        tessellator.addVertex((double) p_73734_0_, (double) p_73734_1_, 0.0);
        tessellator.draw();
        GL11.glEnable(3553);
        GL11.glDisable(3042);
    }
