...
public class ExtraBeeMutation implements IBeeMutation {
    ...
    ExtraBeeMutation.MutationRequirement req;
    ...
    public static void doInit() {
        ...
        new ExtraBeeMutation(ExtraBeesSpecies.WATER, ForestryAllele.BeeSpecies.Diligent.getAllele(), ExtraBeesSpecies.RIVER, 10, new ExtraBeeMutation.RequirementBiomeType(Type.RIVER));
        new ExtraBeeMutation(ExtraBeesSpecies.WATER, ForestryAllele.BeeSpecies.Diligent.getAllele(), ExtraBeesSpecies.OCEAN, 10, new ExtraBeeMutation.RequirementBiomeType(Type.OCEAN));
        ...
        new ExtraBeeMutation(ExtraBeesSpecies.BASALT, ForestryAllele.BeeSpecies.Fiendish.getAllele(), ExtraBeesSpecies.TEMPERED, 30, new ExtraBeeMutation.RequirementBiomeType(Type.NETHER));
        new ExtraBeeMutation(ExtraBeesSpecies.TEMPERED, ForestryAllele.BeeSpecies.Demonic.getAllele(), ExtraBeesSpecies.VOLCANIC, 20, new ExtraBeeMutation.RequirementBiomeType(Type.NETHER));
        new ExtraBeeMutation(ExtraBeesSpecies.BASALT, ForestryAllele.BeeSpecies.Cultivated.getAllele(), ForestryAllele.BeeSpecies.Sinister.getTemplate(), 60, new ExtraBeeMutation.RequirementBiomeType(Type.NETHER));
        new ExtraBeeMutation(ExtraBeesSpecies.BASALT, ForestryAllele.BeeSpecies.Sinister.getAllele(), ForestryAllele.BeeSpecies.Fiendish.getTemplate(), 40, new ExtraBeeMutation.RequirementBiomeType(Type.NETHER));
        ...
        new ExtraBeeMutation(ForestryAllele.BeeSpecies.Ended.getAllele(), ExtraBeesSpecies.RELIC, ExtraBeesSpecies.JADED, 2, new ExtraBeeMutation.RequirementPerson("jadedcat"));
    ...
    public ExtraBeeMutation(IAlleleBeeSpecies allele0, IAlleleBeeSpecies allele1, ExtraBeesSpecies mutation, int chance) {
        this(allele0, allele1, (IAllele[]) mutation.getTemplate(), chance, (ExtraBeeMutation.MutationRequirement) null);
    }

    public ExtraBeeMutation(IAlleleBeeSpecies allele0, IAlleleBeeSpecies allele1, ExtraBeesSpecies mutation, int chance, ExtraBeeMutation.MutationRequirement req) {
    ...
    public ExtraBeeMutation(IAlleleBeeSpecies allele0, IAlleleBeeSpecies allele1, IAllele[] mutation, int chance) {
        this(allele0, allele1, (IAllele[]) mutation, chance, (ExtraBeeMutation.MutationRequirement) null);
    }

    public ExtraBeeMutation(IAlleleBeeSpecies allele0, IAlleleBeeSpecies allele1, IAllele[] mutation, int chance, ExtraBeeMutation.MutationRequirement req) {
        super();
        this.species0 = null;
        this.species1 = null;
    ...
    public float getChance(IBeeHousing housing, IAllele allele0, IAllele allele1, IGenome genome0, IGenome genome1) {
        if (this.species0 != null && this.species1 != null && allele0 != null && allele1 != null) {
            ...
            if (this.req != null && !this.req.fufilled(housing, allele0, allele1, genome0, genome1)) {
                ...
                return this.species0.getUID().equals(allele0.getUID()) && this.species1.getUID().equals(allele1.getUID()) ? (float) processedChance : (this.species1.getUID().equals(allele0.getUID()) && this.species0.getUID().equals(allele1.getUID()) ? (float) processedChance : 0.0F);
            }
        } else {
            return 0.0F;
        }
    ...
    abstract static class MutationRequirement {
        ...
        public abstract boolean fufilled(IBeeHousing var1, IAllele var2, IAllele var3, IGenome var4, IGenome var5);
    }

    static class RequirementBiomeType extends ExtraBeeMutation.MutationRequirement {
        Type type;

        public RequirementBiomeType(Type type) {
            super();
            this.type = type;
        }
    ...
    static class RequirementPerson extends ExtraBeeMutation.MutationRequirement {
        String name;
