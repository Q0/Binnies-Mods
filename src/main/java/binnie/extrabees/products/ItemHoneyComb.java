...
public class ItemHoneyComb extends ItemProduct {
    ...
    public static void addSubtypes() {
        ...
        if (!OreDictionary.getOres("itemRubber").isEmpty()) {
            EnumHoneyComb.LATEX.tryAddProduct(OreDictionary.getOres("itemRubber").get(0), 100);
        } else {
        ...
        if (!OreDictionary.getOres("crushedUranium").isEmpty()) {
            EnumHoneyComb.URANIUM.tryAddProduct(OreDictionary.getOres("crushedUranium").get(0), 50);
        }
        ...
        if (!OreDictionary.getOres("dustSulfur").isEmpty()) {
            EnumHoneyComb.ACIDIC.addProduct(OreDictionary.getOres("dustSulfur").get(0), 75);
        }
        ...
        if (!OreDictionary.getOres("dustObsidian").isEmpty()) {
            EnumHoneyComb.SHADOW.tryAddProduct(OreDictionary.getOres("dustObsidian").get(0), 75);
        } else {
        ...
        if (!OreDictionary.getOres("dustSawdust").isEmpty()) {
            EnumHoneyComb.SAWDUST.tryAddProduct(OreDictionary.getOres("dustSawdust").get(0), 100);
        } else if (!OreDictionary.getOres("sawdust").isEmpty()) {
            EnumHoneyComb.SAWDUST.tryAddProduct(OreDictionary.getOres("sawdust").get(0), 100);
        }
        ...
        if (!OreDictionary.getOres("dustCertusQuartz").isEmpty()) {
            EnumHoneyComb.CERTUS.tryAddProduct(OreDictionary.getOres("dustCertusQuartz").get(0), 20);
        }
        EnumHoneyComb.ENDERPEARL.addProduct(honeyDrop, 25);
        if (!OreDictionary.getOres("dustEnderPearl").isEmpty()) {
            EnumHoneyComb.ENDERPEARL.tryAddProduct(OreDictionary.getOres("dustEnderPearl").get(0), 25);
        }
