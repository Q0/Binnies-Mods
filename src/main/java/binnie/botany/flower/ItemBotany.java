        ...
        if (this.getStage() == EnumFlowerStage.POLLEN) {
            ...
            if (world.canPlaceEntityOnSide(blockFlower, x, y, z, false, side, (Entity) player, itemstack)) {
                ...
                if (this.placeBlockAt(itemstack, player, world, x, y, z, side, px, py, pz, j1)) {
                    world.playSoundEffect((double) (x + 0.5f), (double) (y + 0.5f), (double) (z + 0.5f), blockFlower.stepSound.func_150496_b(), (blockFlower.stepSound.getVolume() + 1.0f) / 2.0f, blockFlower.stepSound.getPitch() * 0.8f);
                    --itemstack.stackSize;
                }
                return true;
            }
