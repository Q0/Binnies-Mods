...
public class ModuleGardening implements IInitializable {
    ...
    public void preInit() {
        ...
        GameRegistry.registerBlock(Botany.plant = new BlockPlant(), (Class) ItemWeed.class, "plant");
        GameRegistry.registerBlock(Botany.soil, (Class) ItemSoil.class, "soil");
        GameRegistry.registerBlock(Botany.loam, (Class) ItemSoil.class, "loam");
        GameRegistry.registerBlock(Botany.flowerbed, (Class) ItemSoil.class, "flowerbed");
        GameRegistry.registerBlock(Botany.soilNoWeed, (Class) ItemSoil.class, "soilNoWeed");
        GameRegistry.registerBlock(Botany.loamNoWeed, (Class) ItemSoil.class, "loamNoWeed");
        GameRegistry.registerBlock(Botany.flowerbedNoWeed, (Class) ItemSoil.class, "flowerbedNoWeed");
        ...
        GameRegistry.registerBlock(Botany.ceramic, (Class) ItemMetadata.class, "ceramic");
        BinnieCore.proxy.registerCustomItemRenderer(Item.getItemFromBlock(Botany.ceramic), new ItemMetadataRenderer());
        GameRegistry.registerBlock(Botany.stained, (Class) ItemMetadata.class, "stained");
        ...
        GameRegistry.registerBlock(Botany.ceramicTile, (Class) ItemMetadata.class, "ceramicPattern");
        GameRegistry.registerBlock(Botany.ceramicBrick, (Class) ItemMetadata.class, "ceramicBrick");
