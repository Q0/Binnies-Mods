...
public class WindowCompartment extends WindowMachine implements IWindowAffectsShiftClick {
    ...
    public void initialiseClient() {
        ...
        final ControlTabBar<Integer> tab = new ControlTabBar<Integer>(controlCompartment, 0.0f, 0.0f, 24.0f, (float) compartmentPageHeight, Position.Left) {
            @Override
        ...
        if (tabs2.length > 0) {
            final ControlTabBar<Integer> tab2 = new ControlTabBar<Integer>(controlCompartment, (float) (24 + compartmentPageWidth), 0.0f, 24.0f, (float) compartmentPageHeight, Position.Right) {
                @Override
                public ControlTab<Integer> createTab(final float x, final float y, final float w, final float h, final Integer value) {
                    return new ControlTabIcon<Integer>(this, x, y, w, h, value) {
                        @Override
        ...
        y2 += 20;
        final ControlButton searchButton = new ControlButton(controlCompartment, (float) (compartmentWidth - 24 - 64 - 8), (float) compartmentPageHeight, 64.0f, 16.0f, "Search") {
            @Override
    ...
    public void createSearchDialog() {
        new Dialog(this, 252.0f, 192.0f) {
            ...
            private void updateSearch() {
                ...
                /*if (this.sortByName) { //TODO:FIX
                    final List list = new LinkedList(slotIds.entrySet());
                    Collections.sort((List<Object>) list, new Comparator() {
                        @Override
                        public int compare(final Object o1, final Object o2) {
                            return -((Map.Entry) o2).getValue().compareTo(((Map.Entry) o1).getValue());
                        }
                    });
                    ...
                    slotIds = (Map<Integer, String>) result;
                }*/
                int y = 0;
                int x = 0;
                final int width = 108;
