...
class ModelCompartment extends ModelBase {
    ...
    public ModelCompartment() {
        ...
        (this.Column1 = new ModelRenderer((ModelBase) this, 0, 0)).addBox(-8.0f, 8.0f, -8.0f, 4, 16, 4);
        ...
        (this.Column4 = new ModelRenderer((ModelBase) this, 0, 0)).addBox(4.0f, 8.0f, -8.0f, 4, 16, 4);
        ...
        (this.Column2 = new ModelRenderer((ModelBase) this, 0, 0)).addBox(-8.0f, 8.0f, 4.0f, 4, 16, 4);
        ...
        (this.Column3 = new ModelRenderer((ModelBase) this, 0, 0)).addBox(4.0f, 8.0f, 4.0f, 4, 16, 4);
        ...
        (this.Lid_1 = new ModelRenderer((ModelBase) this, 48, 0)).addBox(-4.0f, 9.0f, -7.0f, 8, 5, 3);
        ...
        (this.Body_1 = new ModelRenderer((ModelBase) this, 0, 24)).addBox(-4.0f, 14.0f, -7.0f, 8, 10, 3);
        ...
        (this.Lock_1 = new ModelRenderer((ModelBase) this, 22, 24)).addBox(-1.0f, 12.0f, -8.0f, 2, 4, 1);
        ...
        (this.Lid_2 = new ModelRenderer((ModelBase) this, 48, 0)).addBox(-4.0f, 9.0f, -7.0f, 8, 5, 3);
        ...
        (this.Body_2 = new ModelRenderer((ModelBase) this, 0, 24)).addBox(-4.0f, 14.0f, -7.0f, 8, 10, 3);
        ...
        (this.Lock_2 = new ModelRenderer((ModelBase) this, 22, 24)).addBox(-1.0f, 12.0f, -8.0f, 2, 4, 1);
        ...
        (this.Body = new ModelRenderer((ModelBase) this, 16, 0)).addBox(-4.0f, 8.0f, -4.0f, 8, 16, 8);
        this.Body.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.Body.setTextureSize(128, 128);
        this.Body.mirror = true;
        this.setRotation(this.Body, 0.0f, 0.0f, 0.0f);
        (this.Lid_3 = new ModelRenderer((ModelBase) this, 48, 0)).addBox(-4.0f, 9.0f, -7.0f, 8, 5, 3);
        ...
        (this.Body_3 = new ModelRenderer((ModelBase) this, 0, 24)).addBox(-4.0f, 14.0f, -7.0f, 8, 10, 3);
        ...
        (this.Lock_3 = new ModelRenderer((ModelBase) this, 22, 24)).addBox(-1.0f, 12.0f, -8.0f, 2, 4, 1);
        ...
        (this.Lid_4 = new ModelRenderer((ModelBase) this, 48, 0)).addBox(-4.0f, 9.0f, -7.0f, 8, 5, 3);
        ...
        (this.Body_4 = new ModelRenderer((ModelBase) this, 0, 24)).addBox(-4.0f, 14.0f, -7.0f, 8, 10, 3);
        ...
        (this.Lock_4 = new ModelRenderer((ModelBase) this, 22, 24)).addBox(-1.0f, 12.0f, -8.0f, 2, 4, 1);
